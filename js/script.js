...
const chapters = [
    ...
    },
    {
        ...
        content: `
            ...
            เสียงของตนผมที่บ่นออกมาเบาๆ ผมไม่เคยสนใจการเรียนหรือเพื่่อนร่วมชั้นเลย </br>
    ...
    },
    {
        ...
        content: `
            ...
            ลุงชัยเริ่มสร้างน้ำมาเพื่อทำเกี๋ยวเตี๋ยวมาให้ผมกินหลังนั่งลงที่โต๊ะ</br></br>

            เสียงของกระดิกดังขึ้นพร้อมกับก๋วยเตี๋ยวชามใหญ่จะมาเสริฟที่โต๊ะของผม</br></br>
            ...
            ลุงชัยเริ่มขมวดคิ้ว และมาเปิดตาขวาของผม </br></br>อะไรหนะเหนือนตัวเลขเลย พลังธรรมชาติรึ</br></br>

            ผมเริ่มรู้สึกแปลกใจกับคำถาม เริ่มครุ้นคิดในใจว่า </br></br>อะไร ตาเราเป็นอะไร ตัวเลขในตา ห้ะ?</br>

            ไปทำไรมาเนี่ย ตาเริ่มมีแสงเฉยเลย</br></br> ลุงพูดพร้อมค้ำคาง แล้วทำหน้าสงสัย</br>

            ผมเริ่มรู้สึกรู้สึกปวดหัวอย่างรุนแรง มันเหมือนมีอะไรบางอย่างกำลังดึงดูดพลังจากภายในตัวของผม ผมพยายามควบคุมตัวเอง แต่ไม่สำเร็จ สายตาของผมเริ่มพร่ามัว และรู้สึกตาเริ่มสูญเสียการมองเห็น</br></br>

            ริว! เป็นไรหนะ?</br></br> ลุงรีบวิ่งเข้ามาหาผม</br>

            แต่ก่อนที่ผมจะตอบอะไรได้ไป พลังบางอย่างก็ระเบิดออกจากตัว ทุกสิ่งรอบตัวหยุดนิ่ง แม้แต่ลมที่พัดผ่านก็หยุดลง ริวเห็นลุงยืนนิ่งเหมือนรูปปั้น ก่อนที่ศีรษะของลุงจะระเบิดออกเป็นเศษฝุ่นกระจายไปในอากาศ</br>

            ผมตกใจสุดขีด ไม่รู้ว่าควรจะทำอะไรดี </br></br>ทุกอย่างจริงรึเปล่า </br></br>ก่อนที่จะมองลงไปที่มือเปื้อนเลือด ผมร้องออกมาด้วยความหวาดกลัวและความเจ็บปวด ผมมองดูมือตัวเองที่สั่นเทา และสังเกตเห็นว่าเส้นผมทุกเส้นกำลังเปลี่ยนจากสีน้ำตาลเข้มเป็นสีขาวเงิน
    ...
    },
    {
        ...
        content: `
            ...
            ในวันใหม่จากวันเดิมอันพวง(พะ-วง) แสงสุริยาสาดส่องลงที่ตาของผม เป็นสัญญานวันใหม่ที่ดี แต่ในหัวของผมมันเต็มไปด้วย ภาพวันวานที่ร้านก๋วยเตี๋ยว มันยังคงทำให้ผมรู้สึกคลี่นไส้อยู่เป็นระยะ ๆ ตาที่ขวารู้สึกปวดหน่อย ๆ คงไม่มีอะไรแปลกไปหรอกมั้ง  </br></br>
        ...
        content: `
            ...
            *ตึก*</br>
            ผมนั่งลงที่โต๊ะหลังสุดแบบที่เคยทำ อาจารย์กำลังสร้างน้ำผสมหมึกเขียนลงหนังสือบันทึกประจำวัน เพื่อเตรียมการสอนสำหรับวันนี้</br></br>
    ...
    },
    {
        ...
        content: `
            ...
            คงไม่มีอะไรผิดแปลกไปหรอกนะ ผมหยิบโทรศัพท์ขึ้นมาดูเวลา </br></br>
            15:56 นาที</br></br>
