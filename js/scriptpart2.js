...
ดูเหมือนตรงบันไดจะถูพื้นยังไม่เสร็จ น้ำแฉะเต็มไปหมด แต่แม่บ้านไม่คิดจะติดป้ายอะไรหน่อยหรอ 
...
ผมเดินเหยียบน้ำขังด้านหลัง ทั้ง ๆ ที่แน่ใจแล้วว่าจะไม่เปียก แต่ก็ชั่งมันเถอะ ผมเดินไมาหยิบ กิ่งไม้เป็น ๆ สองท้อนมาต่อกัน กันจะเริ่มดึงพลังของผมมาใช้ สมัยเด็กผมเคยทำให้เพื่อนดู กิ่งไม้ที้งสองค่อย ๆ ผสานกันจนสนิท ผมชืมบอกไป ที่โรงเรียนการใช้พลังเป็นสิ่งต้องห้าม เพราะอาจทำใหห้เกิดเหตุที่ไม่ตั้งใจได้ แต่ที่นี่ไม่มีใครเห็นนิ ผมเริ่มต่อไม้ไปเรื่อย ๆ จนมีความยาว 6 เมตรเห็นจะได้ ผมคิดในหัวให้ไม้มันอ่อนลงจนเป็นเหมือนเถาวัลย์
