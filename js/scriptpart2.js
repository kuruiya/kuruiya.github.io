...
ห้ะ พ.. พฤกษา ผมทำอะไรอยู่ที่นี้ เธอไม่ได้โกหกนิ แล้วทำไมเธอยังไม่เป็นอะไรเลย ทั้ง ๆ ทีลุงชัยก็..</br></br>
...
ภาพตัดอีกแล้วหรอ.......
    ...
    {
        title: "บทที่ 11 : พินาศ",
        content: `ซีด ๆ ๆ </br>
เสียงไฟจี่ ๆ ดังมาจากด้านหน้าของผมไม่ไกลมาก</br>
ดูเหมือนรอบ ๆ ห้องนี้จะมืดไปหมด แสงไฟสีส้มสลัว ๆ จากโคมไฟบนโต๊ะไม้เก่า ๆ ข้างหน้าผมเป็นแหล่งแสงเดียวที่ส่องสว่างอยู่ตอนนี้</br></br>

ตื่นแล้วหรอ</br>
หือ</br></br>

ผมมองไม่เห็นอะไรเลย สิ่งที่เห็นมีเพียงหลอดไฟที่ส่องเข้าตาผมเท่านั้น </br>
ดูเหมือนว่า ผมอาจจะเกมแล้วแหละ ทุกอย่างมันเหมือนหนังนักสืบยังไงอย่างนั้นเลย </br></br>

พูดออกมาดี ๆ ก็ได้นะ </br></br>

ผมเลือกที่จะเงียบเพื่อดูสถานะการก่อน</br>
ผมยังไม่รู้เลยว่าข้างหน้าผมคือใคร แต่ถ้าให้ลองเดาดูข้างหน้าก็อาจจะเป็นนักสืบ หรือ ไม่ก็ตำรวจกระมั้ง</br></br>

รู็จักลุงชัยใช่ไหม</br>
ห้ะ </br></br>

*พุก*</br></br>

หมัดตรงหนึ่งมัดถูกซัดเข้าหน้าผมอย่างจัง</br>
เจ็บ เจ็บ เป็นบ้าเลย บังอาจน้าาา..</br></br>

สำนักงานตำรวจประจำจังหวัดสมุทรปราการ</br>
วันที่ 18 กรกฎาคม</br>
เวลา 13:16 นาที</br>

ได้เจอกันแน่ ไอบ้านี่มาต่อยหน้าฉัน</br></br>

บรรยากาศรอบ ๆ เริ่มช้าลง สีของทุกสิ่งก็เริ่มจืดลงเช่นกัน</br>
ริวกำลังจะเข้าสู่ห้วงที่ทุกอย่างหยุดนิ่ง</br></br>

*ปัก*</br></br>

พูดออกมาสิไอฆาตกร</br>
เฮ..</br>

ทำไมหละทั้ง ๆ ที่เรารู้สึกว่ากำลังเข้าสู่ห้วงนั้นแล้วแท้ ๆ </br></br>

จ๊าก!!</br></br>

อยู่ดี ๆ อกมันก็ร้อนขึ้นมา ร้อนจนรู้สึกว่ามีลาวาอยู่บนอกเลย</br></br>

เดี๋ยวจะบอกให้รู้ไว้นะ ไอไร้การศึกษา อำนาจสวรรค์ประธาน จำเป็นต้องใช้เลือดมาเป็นพลังงาน ฉันก็แค่หยุดเส้นเลือดแถว ๆ นั้นไว้ให้เลือดที่เริ่มสูบฉีด ไหลเข้าไปใน G protector ที่ติดอยู่ที่อกนายแทนยังไงหละ</br>
อย่าพยายามขัดขืนเลย นายทำอะไรไม่ได้หรอก</br></br>

ฉันไม่รู้ ไม่รู้เรื่องอะไรทั้งนั้น ลุงชัยเป็นยังไงฉันยังไม่รู้เลย</br></br>

ดูเหมือนตอนนี้ชายที่ใจเย็นคนนั้น จะเริ่มรู้สึกร้อนรนแล้ว</br></br>

เอาเจ้านี้ออกไปหน่อยมันร้อนขึ้นเรื่อย ๆ เลย </br>
ขอร้องหล่ะ...
`
     
    },
    {
        title: "บทที่ 12 : Alice",
        content:`
อ้า! ร้อน</br></br> 

อกของผมมันร้อนเหมือนกำลังจะระเบิดเลย คนในของนี้คือใครทำแบบนี้กับผมทำไม</br></br>

นายอยู่ในเหตุการณ์วันนั้น ฉันเห็นมากับตา</br>
อะไรคุณหมายถึงอะไร</br>
ถ้าแกไม่ยอมพูด ทั้งหมดที่ทนอยู่ก็จะได้ทนต่อไปนี้แหละ</br>
ไอสารเลว แกเป็นใครมาติดเครื่องบ้านี่กับฉัน</br> 
เริ่มหยาบแล้วนะแก ไอฆาตกรไร้น้ำยา ฉันลงทุนกลับมาที่นี่เพื่อสืบเรื่องนี้เอง ฉันรู้ทุกอย่างนั้นแหละ</br></br>

ผมจะไม่ยอมพูอะไรเด็ดขาด ผมจะทำให้ผมเป็นผู้บริสุทธิ์ให้ได้ ถึงจะร้อนเพียงใดก็ตาม ผมก้มลงไปมองที่เครื่องนรกนั้น ก่อนจะสังเกตุว่ามันมีสีส้มสว่าง และ พองขึ้นจากเดิม </br></br>

ขัดขืนใหญ่เลย มันจะฆ่าแกแล้วนะพูดอะไร ซักอย่างแล้วฉันจะยอมปล่อยแก</br></br>

ถ้าหากเราปริปากพูดขึ้นมา เราก็จะรอด ริวพูดมันออกไป</br></br>

ฉันเป็....</br></br>

*ตึง!*</br></br>

เสียงดังจากประตูที่เปิดออก มีคนสามคนเดินเข้ามา กระซิบอะไรกันซักอย่างก่อนที่จะเดินมาที่คนข้างหน้าผม </br></br>

ปล่อยตัวเขาไปเถอะ</br>
ต.. แต่มันเป็นคนที่..</br>
ไม่ต้องพูดอะไรหรอก เข้าพ้นจากทุกข้อหา มันไม่มีหลักฐานอะไรที่จะบอกว่าเขาเป็นคนร้ายเลย ลูกลุงเขาเสียไปแล้วนะ</br>
เป็นคนนี้แน่ ๆ ที่ทำหนะ</br>
พอแล้ว เฟย เฟย </br></br>

เฟย เฟยหรอ ทอมคนนั้นอะนะ ผมไม่คิดเลยว่าทุกอย่างมันมาจากเธอ แต่เธอเป็นหลานของลุงชัยหรอ แล้วคนนั้นเป็นใคร</br></br>

*ฟี้ด* เครื่อง G protector ที่อกของผมถูกปลดออก ตอนนี้ท่อนที่เครื่องบ้านั้นติดอยู่กลายเป็นแผลใหญ่ </br></br>

ฉันชื่อ เดช เป็นผู้กอง ผมข้อโทษด้วยที่ลูกสาวของผมมาทำเรื่องอะไรแบบนี้ ต้องขอบคุณทางคุณอลิซ จริง ๆ ที่ช่วยอธิบายทุกอย่างให้ผมฟัง เฟย เฟย ช่วยเอาไฟออกไปทีได้ไหม!? </br></br>

ค่ะ ค่ะ!</br></br>

อลิซหรอ แก้เรื่องอะไรให้ฉันหนะ เธอคนนั้น</br>
ผมมองไปที่เก้าอี้ฝั่งตรงข้ามเป็นเธอจริงด้วยเฟย เฟย</br></br>

ทำไมถึงรู้ว่าฉันอยู่ที่นั้นหละ</br></br>

ผมตะโกนถามเฟย เฟยไป เธอบอกแค่เพียงว่า</br></br>

 ถ้านายทำให้อลิซเป็นอะไรขึ้นมาล่ะก็</br></br>

เฟย เฟยเดินทำหน้าบึ้ง เดินออกจากห้อง</br></br>

ผมลุกเดินออกไปตาม </br></br>

ห้องสอบสวน 122</br></br>

ดูเหมือนว่าเธอน่าจะตามเรามาที่นั้นได้ เพราะปัญหาทุกอย่างระหว่างทางทั้ง พื้นเปียก และน้ำขัง เธอก็เป็นคนมาก่อกวนเราทั้งนั้น</br>
เราไปทำอะไรให้เธอไม่พอใจงั้นหรอ หรือเธอแค่ชอบอลิซแล้วไม่พอใจที่เราทั้งสองเป็นแฟนกัน</br></br>

ริว!</br></br>

เสียงนี้ เสียงที่คุ้นเคย</br></br>

เธอเป็นอะไรไหม</br>
ฉันไม่เป็นไรหรอก ว่าแต่เธอสอบเสร็จแล้วหรอ</br>
อาจารย์เลี่อนสอบภาษาไทย หายห่วงเถอะ</br></br>

ดีที่อาจารย์ไพรทูลเลื่อนสอบไป โชคดีไปที
`
